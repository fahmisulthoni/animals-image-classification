# -*- coding: utf-8 -*-
"""FahmiSulthoni_Submission3final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nh0l4v7h2DOV6xHWm97-LJKnK55WIZZ7
...
DATADIR = '/content/gdrive/MyDrive/animals/animals/'

import os

animals = os.path.join('/content/gdrive/MyDrive/animals/animals/')

print(os.listdir(animals))

import shutil

ignore_hewan = ['Chimpanzee']

for x in ignore_hewan:
  path = os.path.join(animals, x)
  shutil.rmtree(path)

list_hewan = os.listdir(animals)
print(list_hewan)
...
animals_sorted = sorted(list_hewan)
animals_id = 0
for i in range(2):
  for j in range(2):
    try:
...
class myCallback(tf.keras.callbacks.Callback):
  def on_epoch_end(self, epoch, logs={}):
    if(logs.get('acc')>0.80 and logs.get('val_acc')>0.80):
      print("\nAkurasinya sudah lebih dari 80%")
